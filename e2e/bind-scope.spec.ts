import { Container, Injectable, ScopesEnum } from '../src';
...
describe('bind scope', () => {
  ...
  it('should create singleton when setting scope to singleton', () => {
    container.bind(TestClass).scope(ScopesEnum.Singleton);
  ...
  it('should create transient when setting scope to transient', () => {
    container.bind(TestClass).scope(ScopesEnum.Transient);
  ...
  it('should work for mixed', () => {
    container.bind(MasterClass).scope(ScopesEnum.Transient);
  ...
  it('should assign scope to father/base class', () => {
    ...
    container.bind(BaseImp).scope(ScopesEnum.Transient);
